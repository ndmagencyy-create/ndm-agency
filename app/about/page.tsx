...
export default function About() {
  return (
    <>
      ...
      <div className="px-8 md:px-32 py-32 text-white">
        ...
        <section className="text-center mb-32">
          <motion.h1
            ...
            className="text-6xl md:text-8xl font-extrabold bg-gradient-to-r from-white via-green-400 to-white bg-clip-text text-transparent"
          >
          ...
          <motion.p
            ...
            className="mt-10 text-xl text-white/70 max-w-3xl mx-auto"
          >
        ...
        <section className="grid md:grid-cols-2 gap-16 items-center mb-32">
          ...
          <motion.div
            ...
            transition={{ duration: 1 }}
            viewport={{ once: true }}
            className="p-10 bg-white/5 backdrop-blur-md rounded-2xl border border-green-500/20 shadow-2xl"
          >
        ...
        {/* SECTION FONDATEUR */}
<section className="grid md:grid-cols-2 gap-16 items-center mb-32 px-8 md:px-32">
  {/* PHOTO */}
  <motion.div
    initial={{ opacity: 0, x: -80 }}
    whileInView={{ opacity: 1, x: 0 }}
  ...
  >
    <div className="w-64 h-64 md:w-72 md:h-72 rounded-2xl overflow-hidden border-4 border-green-500/50 shadow-2xl">
      <img
  ...
  <motion.div
    ...
    transition={{ duration: 1 }}
    viewport={{ once: true }}
    className="p-8 bg-white/5 backdrop-blur-md rounded-2xl border border-green-500/20 shadow-2xl"
  >
    <h2 className="text-3xl md:text-4xl font-bold text-green-400 mb-4">
      MR NACIRI Mohamed Mamoun
    </h2>
    <h3 className="text-xl text-white/80 mb-6">Fondateur & Directeur de NDM Agency</h3>
    ...
    <p className="text-white/70 leading-relaxed text-lg">
      ...
      l’expérience NDM et voir votre projet atteindre son plein potentiel.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              ...
              <motion.div
                ...
                className="p-10 bg-white/5 backdrop-blur-md rounded-2xl border border-green-500/20 shadow-2xl"
              >
                <h3 className="text-5xl font-extrabold text-green-400 mb-4">
                  {stat.number}
                </h3>
        ...
        <section className="text-center">
          ...
          <motion.a
            href="/contact#contact-form" // <- redirige directement vers le formulaire
            whileHover={{ scale: 1.1 }}
            className="inline-block px-10 py-5 bg-green-600 hover:bg-green-500 text-white font-semibold rounded-xl shadow-xl transition-all duration-300"
          >
            Démarrer un projet
          </motion.a>
        </section>
